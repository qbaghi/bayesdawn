...
def lognormvar(mu, sig2):
    ...
    The variance of the exponential of a gaussian distribution of mean mu and
    variance sigma2 is [exp(sigma2)-1]*exp(2*mu + sigma2)
...
if __name__ == "__main__":
    ...
    plt.hlines(
        ...
        linewidth=1,
        linestyles="dashed",
    )  # , label=r"Positive threshold $B_{12} = 3$-$20$")
    ...
    # plt.minorticks_on()
    plt.savefig(
        "/Users/qbaghi/Documents/articles/papers/papers/gaps/figures/2sources_bayes_factors/bayes_2sources_2e-4Hz_randgaps.pdf"
    )
