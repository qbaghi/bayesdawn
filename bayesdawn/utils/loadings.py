...
def create_config_file(file_name="example.ini"):
    ...
    config["InputData"] = {
        "FilePath": "/Users/qbaghi/Codes/data/simulations/mbhb/simulation_3.hdf5",
        "StartTime": 850880,
        "EndTime": 2161600,
    }
    ...
    config["OutputData"] = {
        "DirectoryPath": "/Users/qbaghi/Codes/data/results_dynesty/local/",
...
def load_gaps(config, tm):
    ...
    if config["TimeWindowing"].getboolean("Gaps"):
        ...
        wd_full = gapgenerator.modified_hann(
            tm.shape[0], n_wind=config["TimeWindowing"].getint("DecayNumberFull")
        )
